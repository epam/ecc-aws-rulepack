class PolicyTest(object):
    ...
    def test_resources_with_client(self, base_test, resources, local_session):
        ...
        base_test.assertEqual(security_group_1['IpPermissions'][0]['FromPort'], 1521)
        base_test.assertEqual(security_group_1['IpPermissions'][0]['IpRanges'][0]['CidrIp'], "0.0.0.0/0")
        base_test.assertEqual(security_group_1['IpPermissions'][1]['FromPort'], 7000)
        base_test.assertEqual(security_group_1['IpPermissions'][1]['IpRanges'][0]['CidrIp'], "0.0.0.0/0")
        base_test.assertEqual(security_group_2['IpPermissions'][0]['FromPort'], 22)

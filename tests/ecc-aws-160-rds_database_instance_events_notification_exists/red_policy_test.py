class PolicyTest(object):
     ...
     def test_resources_with_client(self, base_test, resources, local_session):
        ...
        base_test.assertNotEqual(rds_subscription['SourceType'], "db-instance")
        base_test.assertIn('EventCategoriesList', rds_subscription)
        base_test.assertFalse('failure' in rds_subscription['EventCategoriesList'])
        ...
        subscriptions = sns_client.get_topic_attributes(TopicArn = "arn:aws:sns:us-east-1:644160558196:160-sns-topic-red")['Attributes']['SubscriptionsConfirmed']

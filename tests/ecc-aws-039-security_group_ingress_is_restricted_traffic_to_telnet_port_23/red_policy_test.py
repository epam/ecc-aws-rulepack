class PolicyTest(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        for r in resources:
            base_test.assertEqual(r['IpPermissions'][0]['ToPort'], 23)
            base_test.assertEqual(r['IpPermissions'][0]['FromPort'], 23)
...
class PolicyTest_SpecificGroup(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertEqual(resources[0]['IpPermissions'][0]['FromPort'], 23)

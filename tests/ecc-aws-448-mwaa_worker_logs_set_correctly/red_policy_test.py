class PolicyTest(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertCountEqual(
            ...
            [
                'arn:aws:airflow:us-east-1:111111111111:environment/mwaa_448_red',
                'arn:aws:airflow:us-east-1:111111111111:environment/mwaa_448_red2',
            ],
        )
        for r in resources:
            base_test.assertFalse(r['LoggingConfiguration']['WorkerLogs']['Enabled'])
            base_test.assertEqual(r['LoggingConfiguration']['WorkerLogs']['LogLevel'], 'INFO')

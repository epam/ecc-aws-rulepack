class PolicyTest(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertCountEqual(
            ...
            sorted(['sg-0be3d1d06e30fdebc', 'sg-0be3d1d06e30fdedd']),
        )
        for r in resources:
            base_test.assertEqual(r['IpPermissions'][0]['IpProtocol'], 'tcp')
            base_test.assertLessEqual(r['IpPermissions'][0]['FromPort'], 3306)
            base_test.assertGreaterEqual(r['IpPermissions'][0]['ToPort'], 3306)
...
class PolicyTest_SpecificGroup(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertLessEqual(resources[0]['IpPermissions'][0]['FromPort'], 3306)
        base_test.assertGreaterEqual(resources[0]['IpPermissions'][0]['ToPort'], 3306)

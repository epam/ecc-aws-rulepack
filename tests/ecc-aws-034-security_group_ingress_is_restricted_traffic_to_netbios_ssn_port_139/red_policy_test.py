class PolicyTest(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertCountEqual(
            ...
            sorted(['sg-0cebf5524a225a4b7', 'sg-0cebf5524a225a4b8']),
        )
        for r in resources:
            base_test.assertEqual(r['IpPermissions'][0]['IpProtocol'], 'tcp')
            base_test.assertLessEqual(r['IpPermissions'][0]['FromPort'], 137)
            base_test.assertGreaterEqual(r['IpPermissions'][0]['ToPort'], 137)
...
class PolicyTest_SpecificGroup(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertLessEqual(resources[0]['IpPermissions'][0]['FromPort'], 137)
        base_test.assertGreaterEqual(resources[0]['IpPermissions'][0]['ToPort'], 137)

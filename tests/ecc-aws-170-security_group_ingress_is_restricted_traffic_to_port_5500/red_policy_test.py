class PolicyTest(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertCountEqual(
            ...
            ['sg-0e24cbbe76e4a9028', 'sg-0e24cbbe76e4a9038'],
        )
        for r in resources:
            base_test.assertEqual(r['IpPermissions'][0]['IpRanges'][0]['CidrIp'], '0.0.0.0/0')
            base_test.assertEqual(r['IpPermissions'][0]['IpProtocol'], '-1')
...
class PolicyTest_SpecificGroup(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertEqual(resources[0]['IpPermissions'][0]['IpProtocol'], '-1')

class PolicyTest(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        for r in resources:
            ...
            base_test.assertLessEqual(r['IpPermissions'][0]['FromPort'], 80)
            base_test.assertGreaterEqual(r['IpPermissions'][0]['ToPort'], 80)
...
class PolicyTest_SpecificGroup(object):
    ...
    def test_resources(self, base_test, resources):
        ...
        base_test.assertLessEqual(resources[0]['IpPermissions'][0]['FromPort'], 80)
        base_test.assertGreaterEqual(resources[0]['IpPermissions'][0]['ToPort'], 80)

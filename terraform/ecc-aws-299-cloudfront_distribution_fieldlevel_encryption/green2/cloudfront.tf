resource "aws_s3_bucket" "this" {
  bucket = "299-bucket-${random_integer.this.result}-green2"
  force_destroy = true
}
...
resource "aws_cloudfront_field_level_encryption_config" "this" {
  comment = "299_cloudfront_field_level_encryption_config_green2"

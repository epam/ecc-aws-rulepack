output "resource_prefix" {
  value = {
    ...
    event_bus                   = "${local.suffix}-${var.resource_type}-event-bus-${local.compliance_status}"
    event_rule                  = "${local.suffix}-${var.resource_type}-rule-${local.compliance_status}"
    ...
    iam_cert                    = "${local.suffix}-${var.resource_type}-cert-${local.compliance_status}"
    iam_group                   = "${local.suffix}_${var.resource_type}_group_${local.compliance_status}"
    ...
    iam_user                    = "${local.suffix}_${var.resource_type}_user_${local.compliance_status}"

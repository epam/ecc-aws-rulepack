...
resource "tls_self_signed_cert" "this1" {
...
resource "tls_self_signed_cert" "this2" {
  private_key_pem = tls_private_key.this.private_key_pem
...
resource "aws_iam_server_certificate" "this" {
  ...
  certificate_body = tls_self_signed_cert.this1.cert_pem
...
resource "aws_acm_certificate" "this2" {
  private_key      = tls_private_key.this.private_key_pem
  certificate_body = tls_self_signed_cert.this2.cert_pem
}